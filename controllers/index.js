...
router.get('/list', function (req, res, next) {
    ...
    let pageNow = req.query.page ? req.query.page : 1;
    //查询条件
    let tagid = req.query.id ? req.query.id : 0;
    let key = req.query.key ? req.query.key : 0;
    let date = req.query.date ? req.query.date : 0;
    //获取文章列表
    let param = {'pageSize': pageSizes, 'pageNow': pageNow, 'tagid': tagid, 'key': key, 'date': date};
