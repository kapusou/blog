...
!function (a, b) {
    ...
    n.extend({
        ...
        ajaxSettings: {
            ...
            processData: !0,
            async: !0,
            contentType: "application/x-server-form-urlencoded; charset=UTF-8",
            accepts: {
                "*": nb,
                text: "text/plain",
                html: "text/html",
    ...
    n.ajaxSetup({
        ...
        var e, f, g,
            h = b.jsonp !== !1 && (Gb.test(b.url) ? "url" : "string" == typeof b.data && !(b.contentType || "").indexOf("application/x-server-form-urlencoded") && Gb.test(b.data) && "data");
